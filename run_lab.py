...
descriptions_folder = '<replace with filepath to descriptions directory in lab instance'
...
def generate_json(descriptions_file_list):
    ...
    json_list = []
    # iterate thru list of descriptions, each time with a new fruit dictionary
